...
int main(void) {
    float fabsf(float);
    int i, n=10;
    double xi_directe, double_xi_rec, double_error_abs, double_error_rel, x0 = 1, x1 = 1.0/3.0, un_tercio = 1.0/3.0, tres = 3.0, 
    ...
    */
    ...
    printf("i \t xi directe \t\t xi float rec\t\terror abs\t\terror rel\t\txi double rec\t\terror abs\t\terror rel\t\t\n");

    printf("%d \t %.9le \t %.9le \t %.9le \t %.9le%% \t %.9le \t %.9le \t %.9le%%\n", 
            0, x0, x0, 0.0, 0.0, x0, 0.0, 0.0);

    printf("%d \t %.9le \t %.9le \t %.9le \t %.9le%% \t %.9le \t %.9le \t %.9le%%\n", 
            1, x1, x1, 0.0, 0.0, x1, 0.0, 0.0);
    ...
    for (i = 0; i < n; i++) {
        ...
        printf("%d \t %.9le \t %.9le \t %.9le \t %.9le%% \t %.9le \t %.9le \t %.9le%%\n", 
            i+2, xi_directe, float_xi_rec, float_error_abs, float_error_rel, double_xi_rec, double_error_abs, double_error_rel);
